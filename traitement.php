     ...
     foreach($dirs as $dir){
        if (is_dir($url.$dir)){
             if ($dir == "..") {
                ...
                if (isset($_GET['dossier'])) {?>
                    <a class="folder" href="index.php?dossier=<?php echo $dossier.$dir; ?>/">
                        <img src="icone/Folder.png" alt="" width="80"><?php echo $dir;?>
                    </a>
                <?php } else {?>
            ...
            if (isset($dir)){
                ...
                if ($extension == "html"){
                    ?>
                    <a class="folder">
                        <img src="icone/html.png" alt="" width="80"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "css"){
                    ?>
                    <a class="folder">
                        <img src="icone/css.png" alt="" width="80"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "png"){
                    ?>
                    <a class="folder">
                        <img src="icone/png.png" alt="" width="80"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "js"){
                    ?>
                    <a class="folder">
                        <img src="icone/javascript.png" alt="" width="80"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "php"){
                    ?>
                    <a class="folder">
                        <img src="icone/php.png" alt="" width="80"><?php echo $dir; ?>
                    </a>
                    <?php
                } elseif ($extension == "pdf"){
                    ?>
                    <a class="folder">
                        <img src="icone/pdf.png" alt="" width="80"><?php echo $dir; ?>
                    </a>
                    <?php
                } else{
                    ?>
                    <a class="folder">
                        <img src="icone/txt.png" alt="" width="80"><?php echo $dir; ?>
                    </a>
                    <?php
                }
            }
